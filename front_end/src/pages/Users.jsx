...
function Users(){
    ...
    const url=`http://localhost:3001/api/user/register?username=${data.username}&email=${data.email}&password=${data.password}&phone_number=${data.phone_number}`
    ...
    return (
        ...
        <form  className="form-box" id="form">
            ...
            <form className="was-validated">
                ...
                <Link  className="btn btn-outline-primary" onClick={(e)=>Enviar(e)} to="/VerUsers">Create</Link>
            </div>
                </div>
